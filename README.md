# 将React应用程序部署到GitHub Pages

\* 使用 `create-react-app`创建

# Introduction

本教程介绍如何将一个由`create-react-app`创建的React应用部署到GitHub Pages.

你可以浏览部署好的页面 [https://lnlynn.github.io/react-gh-pages/](https://lnlynn.github.io/react-gh-pages/).
